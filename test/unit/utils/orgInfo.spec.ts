...
enableFetchMocks();
import { getLinkedOrgs, lookupUserOrgs, linkNarrativeToOrg } from '../../../src/client/utils/orgInfo';
            ...
            return {
                body: JSON.stringify({
                    "error": {
                        ...
                        "message": "Error contacting workspace at https://kbase.us/services/ws",
                        "callid": "123",
                        "time": 1595032219199
                      }
                }),
            ...
            return {
                body: JSON.stringify({
                    error: {
                        ...
                        message: '40010 Request already exists: Request exists with ID: SOME-ID',
                        callid: 'somecallid',
                        time: 1595030863696
                    }
                }),
