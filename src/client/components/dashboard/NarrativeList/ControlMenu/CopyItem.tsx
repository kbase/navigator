  ...
  render() {
    return (
      <div style={{textAlign: 'center'}}>
        ...
        <div>
          <input className="w-100 pa2 mb2 br2 ba b--solid b--black-20"
            type="text"
            value={this.state.newName}
            onChange={(e) => this.validateName(e)}></input>
        </div>
        <div>
          <DashboardButton onClick={() => this.makeCopy()} bgcolor={'lightblue'}>Ok</DashboardButton>
          <DashboardButton onClick={this.props.cancelFn}>Cancel</DashboardButton>
        </div>
      </div>
    );
  }
